...
set :repo_url,        'git@gitlab.builder.ai:clientprojects/ongoing/veryusapp/veryusapp_ror.git'
set :application,     'very_us'
set :user,            'ubuntu'
...
set :pty,             false
set :use_sudo,        true
set :rvm_ruby_string, 'ruby-2.6.3' # you probably have this already
